 ...
 */
class Noticia extends \CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Noticia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'codigo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'nombre', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'fechaPublicacion', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'fechaExpericaion', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'descripcion', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'imagen', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Noticia' . "\0" . 'codigoArea');
        }
    ...
    public function setFechaExpericaion($fechaExpericaion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFechaExpericaion', array($fechaExpericaion));

        return parent::setFechaExpericaion($fechaExpericaion);
    }
    ...
    public function getFechaExpericaion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFechaExpericaion', array());

        return parent::getFechaExpericaion();
    }
    ...
    public function setCodigoArea(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Area $codigoArea = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCodigoArea', array($codigoArea));

        return parent::setCodigoArea($codigoArea);
    }
    ...
    public function getCodigoArea()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodigoArea', array());

        return parent::getCodigoArea();
    }
