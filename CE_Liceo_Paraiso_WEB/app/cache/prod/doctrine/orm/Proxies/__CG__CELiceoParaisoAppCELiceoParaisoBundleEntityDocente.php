 ...
 */
class Docente extends \CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Docente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Docente' . "\0" . 'codigo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Docente' . "\0" . 'nombre', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Docente' . "\0" . 'apellidos', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Docente' . "\0" . 'correo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Docente' . "\0" . 'codigoDepartamento');
        }
