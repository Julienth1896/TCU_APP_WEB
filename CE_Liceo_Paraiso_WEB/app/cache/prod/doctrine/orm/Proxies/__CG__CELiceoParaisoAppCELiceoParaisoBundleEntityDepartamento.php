 ...
 */
class Departamento extends \CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Departamento' . "\0" . 'codigo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Departamento' . "\0" . 'nombre', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Departamento' . "\0" . 'descripcion', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Departamento' . "\0" . 'administrador', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Departamento' . "\0" . 'area', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Departamento' . "\0" . 'codigoDocente');
        }
    ...
    public function addCodigoDocente(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Docente $codigoDocente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCodigoDocente', array($codigoDocente));

        return parent::addCodigoDocente($codigoDocente);
    }
    ...
    public function removeCodigoDocente(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Docente $codigoDocente)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCodigoDocente', array($codigoDocente));

        return parent::removeCodigoDocente($codigoDocente);
    }
    ...
    public function getCodigoDocente()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCodigoDocente', array());

        return parent::getCodigoDocente();
    }
