...
class Personal extends \CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Personal implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'codigo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'nombre', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'apellidos', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'correo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'comite', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'codigoDepartamento');
        }
